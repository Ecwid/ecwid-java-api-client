...
import com.ecwid.apiclient.v3.dto.profile.result.StringList
...
data class UpdatedExtrafieldConfig(
	...
	val showForCountry: NullableUpdatedValue<StringList>? = null,
	val showForPaymentMethodIds: NullableUpdatedValue<StringList>? = null,
	val showForShippingMethodIds: NullableUpdatedValue<StringList>? = null,
	val showInInvoice: Boolean? = null,
	val showInNotifications: Boolean? = null,
	val orderBy: Int? = null,
	val surchargeType: NullableUpdatedValue<SurchargeType>? = null,
	val surchargeTaxable: Boolean? = null,
	val showZeroSurchargeInTotal: Boolean? = null,
	val surchargeShortName: NullableUpdatedValue<UpdatedExtrafieldSurchargeConfig>? = null,
