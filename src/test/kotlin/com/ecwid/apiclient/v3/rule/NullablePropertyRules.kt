...
val nullablePropertyRules: List<NullablePropertyRule<*, *>> = listOf(
	...
	IgnoreNullable(FetchedOrder.ExtraFieldsInfo::customerInputType),
	IgnoreNullable(FetchedOrder.ExtraFieldsInfo::id),
	IgnoreNullable(FetchedOrder.ExtraFieldsInfo::orderBy),
	IgnoreNullable(FetchedOrder.ExtraFieldsInfo::orderDetailsDisplaySection),
	IgnoreNullable(FetchedOrder.ExtraFieldsInfo::title),
	IgnoreNullable(FetchedOrder.ExtraFieldsInfo::value),
	...
	IgnoreNullable(FetchedOrder.OrderItem::discountsAllowed),
	IgnoreNullable(FetchedOrder.OrderItem::files),
	...
	IgnoreNullable(FetchedOrder.OrderItem::isCustomerSetPrice),
	IgnoreNullable(FetchedOrder.OrderItem::isGiftCard),
	IgnoreNullable(FetchedOrder.OrderItem::isShippingRequired),
	IgnoreNullable(FetchedOrder.OrderItem::name),
	IgnoreNullable(FetchedOrder.OrderItem::nameTranslated),
	IgnoreNullable(FetchedOrder.OrderItem::price),
	IgnoreNullable(FetchedOrder.OrderItem::priceWithoutTax),
	...
	IgnoreNullable(FetchedOrder.OrderItem::selectedPrice),
	IgnoreNullable(FetchedOrder.OrderItem::shipping),
	IgnoreNullable(FetchedOrder.OrderItem::shortDescription),
	IgnoreNullable(FetchedOrder.OrderItem::shortDescriptionTranslated),
	...
	IgnoreNullable(FetchedOrder.OrderItem::taxable),
	...
	IgnoreNullable(FetchedOrder.OrderItemOptionFile::id),
	IgnoreNullable(FetchedOrder.OrderItemOptionFile::name),
	IgnoreNullable(FetchedOrder.OrderItemOptionFile::size),
	IgnoreNullable(FetchedOrder.OrderItemOptionFile::url),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::adminUrl),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::customerUrl),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::description),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::expire),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::maxDownloads),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::name),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::productFileId),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::remainingDownloads),
	IgnoreNullable(FetchedOrder.OrderItemProductFile::size),
	IgnoreNullable(FetchedOrder.OrderItemSelectedOption::files),
	IgnoreNullable(FetchedOrder.OrderItemSelectedOption::name),
	IgnoreNullable(FetchedOrder.OrderItemSelectedOption::nameTranslated),
	...
	IgnoreNullable(FetchedOrder.OrderItemSelectedOption::valueTranslated),
	IgnoreNullable(FetchedOrder.OrderItemSelectedOption::valuesArray),
	IgnoreNullable(FetchedOrder.OrderItemSelectedOption::valuesArrayTranslated),
	...
	IgnoreNullable(FetchedOrder.Parcel::dimensionUnit),
	IgnoreNullable(FetchedOrder.Parcel::height),
	IgnoreNullable(FetchedOrder.Parcel::length),
	IgnoreNullable(FetchedOrder.Parcel::template),
	IgnoreNullable(FetchedOrder.Parcel::weight),
	IgnoreNullable(FetchedOrder.Parcel::weightUnit),
	IgnoreNullable(FetchedOrder.Parcel::width),
	...
	IgnoreNullable(FetchedOrder.SelectedPrice::value),
	IgnoreNullable(FetchedOrder.Shipment::created),
	IgnoreNullable(FetchedOrder.Shipment::id),
	IgnoreNullable(FetchedOrder.Shipment::label),
	IgnoreNullable(FetchedOrder.Shipment::parcel),
	IgnoreNullable(FetchedOrder.Shipment::shipFrom),
	IgnoreNullable(FetchedOrder.Shipment::shipTo),
	IgnoreNullable(FetchedOrder.Shipment::shippingService),
	IgnoreNullable(FetchedOrder.Shipment::tracking),
	IgnoreNullable(FetchedOrder.ShippingLabelInfo::billingTransactionId),
	IgnoreNullable(FetchedOrder.ShippingLabelInfo::commercialInvoiceUrl),
	IgnoreNullable(FetchedOrder.ShippingLabelInfo::labelFileType),
	IgnoreNullable(FetchedOrder.ShippingLabelInfo::labelUrl),
	...
	IgnoreNullable(FetchedOrder.ShippingServiceInfo::carrier),
	IgnoreNullable(FetchedOrder.ShippingServiceInfo::carrierName),
	IgnoreNullable(FetchedOrder.ShippingServiceInfo::carrierServiceCode),
	IgnoreNullable(FetchedOrder.ShippingServiceInfo::carrierServiceName),
	IgnoreNullable(FetchedOrder.Surcharge::descriptionTranslated),
	IgnoreNullable(FetchedOrder.TaxRule::tax),
	IgnoreNullable(FetchedOrder.TaxRule::zoneId),
	IgnoreNullable(FetchedOrder.Taxes::appliedByDefault),
	IgnoreNullable(FetchedOrder.Taxes::defaultTax),
	IgnoreNullable(FetchedOrder.Taxes::enabled),
	IgnoreNullable(FetchedOrder.Taxes::id),
	IgnoreNullable(FetchedOrder.Taxes::includeInPrice),
	IgnoreNullable(FetchedOrder.Taxes::name),
	IgnoreNullable(FetchedOrder.Taxes::rules),
	IgnoreNullable(FetchedOrder.Taxes::taxShipping),
	IgnoreNullable(FetchedOrder.Taxes::useShippingAddress),
	IgnoreNullable(FetchedOrder.TrackingInfo::estimatedDays),
	IgnoreNullable(FetchedOrder.TrackingInfo::trackingNumber),
	IgnoreNullable(FetchedOrder.TrackingInfo::trackingUrl),
	...
	IgnoreNullable(FetchedOrder::acceptMarketing),
	IgnoreNullable(FetchedOrder::additionalInfo),
	IgnoreNullable(FetchedOrder::affiliateId),
	IgnoreNullable(FetchedOrder::availableShippingOptions),
	IgnoreNullable(FetchedOrder::availableTaxes),
	IgnoreNullable(FetchedOrder::billingPerson),
	IgnoreNullable(FetchedOrder::couponDiscount),
	IgnoreNullable(FetchedOrder::createDate),
	IgnoreNullable(FetchedOrder::createTimestamp),
	IgnoreNullable(FetchedOrder::creditCardStatus),
	IgnoreNullable(FetchedOrder::customDiscount),
	IgnoreNullable(FetchedOrder::customerGroup),
	IgnoreNullable(FetchedOrder::customerGroupId),
	IgnoreNullable(FetchedOrder::customerId),
	IgnoreNullable(FetchedOrder::customerTaxExempt),
	IgnoreNullable(FetchedOrder::customerTaxId),
	IgnoreNullable(FetchedOrder::customerTaxIdValid),
	IgnoreNullable(FetchedOrder::disableAllCustomerNotifications),
	IgnoreNullable(FetchedOrder::discount),
	IgnoreNullable(FetchedOrder::discountCoupon),
	IgnoreNullable(FetchedOrder::discountInfo),
	IgnoreNullable(FetchedOrder::ebayId),
	IgnoreNullable(FetchedOrder::email),
	IgnoreNullable(FetchedOrder::externalFulfillment),
	IgnoreNullable(FetchedOrder::externalOrderId),
	IgnoreNullable(FetchedOrder::externalTransactionId),
	IgnoreNullable(FetchedOrder::externalTransactionUrl),
	IgnoreNullable(FetchedOrder::extraFields),
	IgnoreNullable(FetchedOrder::fulfillmentStatus),
	IgnoreNullable(FetchedOrder::giftCardCode),
	IgnoreNullable(FetchedOrder::giftCardDoubleSpending),
	IgnoreNullable(FetchedOrder::giftCardRedemption),
	IgnoreNullable(FetchedOrder::globalReferer),
	IgnoreNullable(FetchedOrder::handlingFee),
	IgnoreNullable(FetchedOrder::hidden),
	IgnoreNullable(FetchedOrder::id),
	IgnoreNullable(FetchedOrder::ipAddress),
	IgnoreNullable(FetchedOrder::items),
	IgnoreNullable(FetchedOrder::latestDeliveryDate),
	IgnoreNullable(FetchedOrder::membershipBasedDiscount),
	IgnoreNullable(FetchedOrder::orderComments),
	IgnoreNullable(FetchedOrder::orderExtraFields),
	IgnoreNullable(FetchedOrder::paymentMessage),
	IgnoreNullable(FetchedOrder::paymentMethod),
	IgnoreNullable(FetchedOrder::paymentModule),
	IgnoreNullable(FetchedOrder::paymentParams),
	IgnoreNullable(FetchedOrder::paymentStatus),
	IgnoreNullable(FetchedOrder::pickupTime),
	IgnoreNullable(FetchedOrder::pricesIncludeTax),
	IgnoreNullable(FetchedOrder::privateAdminNotes),
	IgnoreNullable(FetchedOrder::referenceTransactionId),
	IgnoreNullable(FetchedOrder::refererId),
	IgnoreNullable(FetchedOrder::refererUrl),
	IgnoreNullable(FetchedOrder::refundedAmount),
	IgnoreNullable(FetchedOrder::refunds),
	IgnoreNullable(FetchedOrder::reversedTaxApplied),
	IgnoreNullable(FetchedOrder::shipments),
	IgnoreNullable(FetchedOrder::shippingOption),
	IgnoreNullable(FetchedOrder::shippingPerson),
	IgnoreNullable(FetchedOrder::subtotal),
	IgnoreNullable(FetchedOrder::subtotalWithoutTax),
	IgnoreNullable(FetchedOrder::tax),
	IgnoreNullable(FetchedOrder::total),
	IgnoreNullable(FetchedOrder::totalAndMembershipBasedDiscount),
	IgnoreNullable(FetchedOrder::totalBeforeGiftCardRedemption),
	IgnoreNullable(FetchedOrder::totalWithoutTax),
	...
	IgnoreNullable(FetchedOrder::vendorOrderNumber),
	IgnoreNullable(FetchedOrder::volumeDiscount),
