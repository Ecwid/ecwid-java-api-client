...
val nonnullPropertyRules: List<NonnullPropertyRule<*, *>> = listOf(
	...
	IgnoreNonnull(UpdatedProduct.ProductOptionChoice.SelectChoice::text),
	IgnoreNonnull(UpdatedProduct.ProductOptionChoice.SelectChoice::type),
	IgnoreNonnull(UpdatedProduct.ProductOptionChoice.SwatchChoice::text),
	IgnoreNonnull(UpdatedProduct.ProductOptionChoice.SwatchChoice::type),
	IgnoreNonnull(UpdatedProduct.ProductOptionChoice.SwatchChoice::hexCodes),
