...
import com.ecwid.api.v3.dto.OrderedStringToStringMap
import com.ecwid.api.v3.dto.order.enums.*
import com.ecwid.api.v3.dto.order.request.*
import com.ecwid.api.v3.dto.order.request.OrderItemOptionFileUploadRequest.UploadFileData
import com.ecwid.api.v3.dto.order.result.FetchedOrder
import com.ecwid.api.v3.dto.order.result.OrdersSearchResult
...
private fun generateTestOrderItem() = UpdatedOrder.OrderItem(
		...
		// productId = util.randomId(), // TODO need to pass existing product id
		categoryId = randomId(),
